...
2.  在中央仓库处创建一个 Pull Request。以 GitHub 为例：
    ...
    ![](Images/15fde6edbe5190a4)
    
    ![](Images/15fde6edbeda949d)
    
    ![](Images/15fde6edc112a514)
